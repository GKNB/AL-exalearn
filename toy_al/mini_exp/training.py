...
parser.add_argument('--log_interval',   type=int,   default=10,
                    help='print log output every x epoch')
...
#    print("len of train_loader = {}".format(len(train_loader)))
    ...
    if epoch % args.log_interval == 0:
        print("Epoch = {}, Average train loss: {:15.8f}".format(epoch, running_loss))
...
def final_test():
    ...
    print("Final test: Average loss = {}".format(np.mean(test_output)))
